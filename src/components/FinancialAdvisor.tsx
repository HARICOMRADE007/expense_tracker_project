...
import { MessageCircle, X, Send, Sparkles, Key, ChevronRight } from 'lucide-react';
        ...
        <>
            ...
            {isOpen && (
                <div className={`fixed bottom-24 right-6 w-96 max-w-[calc(100vw-3rem)] h-[500px] max-h-[calc(100vh-8rem)] rounded-3xl shadow-2xl border backdrop-blur-xl flex flex-col overflow-hidden z-50 transition-all ${isDark
                    ...
                    {/* Header */}
                    <div className={`p-4 border-b flex items-center gap-3 ${isDark ? 'border-gray-700 bg-gray-800/50' : 'border-gray-100 bg-white/50'}`}>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        {!isSetup ? (
                            <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
                                ...
                                <div>
                                    <h4 className="font-bold text-lg mb-2">Activate Advisor</h4>
                                    <p className={`text-sm mb-4 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                        To get personalized insights, the AI needs a "Key" to function.
                                    </p>
